...
namespace RM.src.RM240513
{
    public partial class UC_positions : UserControl
    {
        ...
        /// <summary>
        /// Specifica se l'utente ha aperto i filtri
        /// </summary>
        ...
        private void Update_Dt_filtered()
        {
            ...
            foreach (ListViewItem item in lw_positions.Items) // aggiungo le nuove righe prendendole dalla list view originale
            {
        ...
        private void BtnDeletePoint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (CustomMessageBox.Show(MessageBoxTypeEnum.WARNING, "Cancellare la posizione selezionata?") == DialogResult.OK)
                {
                    ...
                    // Ottengo l'indice della riga selezionata
                    int selectedIndex = lw_positions.SelectedIndices[0];
