...
namespace RM.src.RM240513.Forms.ScreenSaver
{
    /// <summary>
    ...
    public partial class ScreenSaverManager : Form
    {
        ...
        /// <summary>
        /// Indica se la classe è stata correttamente inizializzata
        /// </summary>
        ...
        public ScreenSaverManager(int delayMs, string fileName, bool autoStart)
        {
            delay = delayMs;
            videoFileName = fileName;
            autoStart = true;
