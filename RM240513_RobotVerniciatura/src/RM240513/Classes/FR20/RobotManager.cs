...
using RM.src.RM240513.Classes.FR20.Jog;
using RM.src.RM240513.Forms;
using RM.src.RM240513.Forms.Plant.ViveTracker;
...
namespace RM.src.RM240513
{
    ...
    public class RobotManager
    {
        ...
        private static void StartApplication(string application)
        {
            ...
            if (start)
            {
                // Creazione istanza UC_HomePage e deselezione di tutte le righe in lw_positions
                UC_HomePage uc = (UC_HomePage)FormHomePage.Instance.PnlContainer.Controls["UC_HomePage"];
                uc.InitSelection_lw_positions();
