...
namespace RM.src.RM220930.Forms.Plant.DragMode
{
    ...
    public partial class FormDebugSettings : Form
    {
        ...
        /// <summary>
        /// Evento per modificare la modalità di drag in Tracker
        /// </summary>
        public event EventHandler TrackerModeCheckedChanged;
        ...
        private void PnlInfoTracker_Click(object sender, EventArgs e)
        {
            FormInfoRobot form = new FormInfoRobot(
                "Tracker mode",
                "Registra i punti tramite il movimento del tracker"
                );
            form.ShowDialog();
        }

        private void rbTracker_Click(object sender, EventArgs e)
        {
            if (rbTracker.Checked)
            {
                TrackerModeCheckedChanged?.Invoke(this, EventArgs.Empty);
            }
        }
    }
}
