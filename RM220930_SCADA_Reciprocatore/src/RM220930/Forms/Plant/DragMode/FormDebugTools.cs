...
namespace RM.src.RM220930.Forms.Plant.DragMode
{
    ...
    public partial class FormDebugTools : Form
    {
        ...
        /// <summary>
        /// Evento al premere del pulsante pause monitoring
        /// </summary>
        public event EventHandler ButtonPauseMonitoringClicked;
        /// <summary>
        /// Evento al premere del pulsante stop monitoring
        /// </summary>
        public event EventHandler ButtonStopMonitoringClicked;
        ...
        public void EnableMonitoringButtons(bool isMonitoringStart)
        {
            ...
            btn_stopMonitoring.Enabled = isMonitoringStart;
            btn_stopMonitoring.BackColor = isMonitoringStart ? SystemColors.Control : SystemColors.ControlDark;
            btn_stopMonitoring.BackgroundImage = isMonitoringStart ? Resources.stop : null;
        ...
        public void EnableMovementButtons(bool isInMovement)
        {
            ...
            btn_stopMonitoring.Enabled = isInMovement;
            btn_stopMonitoring.BackColor = !isInMovement ? SystemColors.ControlDark : SystemColors.Control;
            btn_stopMonitoring.BackgroundImage = !isInMovement ? null : Resources.stop;
        }
        ...
        private void ClickEvent_stopMonitoring(object sender, EventArgs e)
        {
            ButtonStopMonitoringClicked?.Invoke(this, EventArgs.Empty);
        }
    }
}
